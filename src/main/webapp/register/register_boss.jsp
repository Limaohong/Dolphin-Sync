...
<form ENCTYPE="multipart/form-data" method="POST" action="<c:url value='useraccount.do' />"  id="useraccount.do" >
      ...
      <input type="text"  name="C_CN" value="${param.C_CN}" class="fieldWidth" style="width: 120px;">
      <font color="red" size="-1">${MsgMap.errorTel}</font>
      <br/>
      <label class="fontSize" >公司電話：</label>
      <input type="text"  name="C_CP" value="${param.C_CP}" class="fieldWidth" style="width: 120px;">
      <font color="red" size="-1">${MsgMap.errorTel}</font>
      <br/>  
