...
<script type="text/javascript">
	...
	function choiceclass(){
		...
		if (confirm("確定選擇此班級 ? ") ) {
			document.myform.action="<c:url value='choiceclassinsertfraction.do?cr_Id=" + cr_Id +"&radiosValue="+radiosValue+"' />" ;
...
<body>
<Form action="<c:url value='choiceclassinsertfraction.do' />" method="POST" name="myform" class="was-validated">
<h2>請選擇要新增的學員班級</h2>
