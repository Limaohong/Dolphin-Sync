...
<form ENCTYPE="multipart/form-data" method="POST" action="<c:url value='update.do' />"  id="update.do" >
      ...
      <font color="red" size="-1">${MsgMap.errorPassword2Empty}${MsgMap.passwordError}${MsgMap.errorPasswordEmpty}</font>            
      <br/>
      
      <label class="fontSize" >老闆驗證碼：</label>
      <input type="text" name="UA_VC" value="${LoginOK.UA_VC}"   class="fieldWidth" style="width: 200px ;color: rgb(100, 100, 100);" readonly="readonly">
      ...
      <img class="d-block w-100" src="${pageContext.request.contextPath}/init/getImage?UA_Acu=${LoginOK.UA_Acu}&type=UserAccount" height='120px' width='180px'>
