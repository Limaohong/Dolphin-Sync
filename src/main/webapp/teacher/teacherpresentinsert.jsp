...
<body>
<form ENCTYPE="multipart/form-data" method="POST" action="<c:url value='teacherpresentinsert.do' />"  id="teacherpresentinsert.do" >
              
      <label class="fontSize" >老師姓名：</label>
      <input type="text" name="TP_Name" value="${param.TP_Name}"  class="fieldWidth" style="width: 180px;">
      <font color="red" size="-1">${MsgMap.errorName}</font>
      <br/>      
     
      <label class="fontSize" >師資介紹：</label>
      <textarea cols="50" rows="5" name="TP_TI">${param.TP_TI}</textarea><BR>
