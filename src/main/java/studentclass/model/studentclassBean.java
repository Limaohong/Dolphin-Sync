...
//	Timestamp SC_LM;
	...
	Integer SC_CI;  		//ClassroomId
	String SC_CN;
	
	Integer SC_SI;  		//StudentId
	String SC_SN;
	@CreationTimestamp
	Timestamp SC_RD;
	@UpdateTimestamp
	...
	public studentclassBean(Integer sC_CI, String sC_CN, Integer sC_SI, String sC_SN) {
		super();
		SC_CI = sC_CI;
		SC_CN = sC_CN;
		SC_SI = sC_SI;
	...
	public studentclassBean(Integer sC_CI, Integer sC_SI) {
		super();
		SC_CI = sC_CI;
		SC_SI = sC_SI;
	}
	...
	public Integer getSC_CI() {
		return SC_CI;
	}

	public void setSC_CI(Integer sC_CI) {
		SC_CI = sC_CI;
	}
	...
	public Integer getSC_SI() {
		return SC_SI;
	}

	public void setSC_SI(Integer sC_SI) {
		SC_SI = sC_SI;
	}
