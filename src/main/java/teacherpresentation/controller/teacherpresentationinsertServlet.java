...
@WebServlet("/teacher/teacherpresentinsert.do")
public class teacherpresentationinsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!errorMsgMap.isEmpty()) {
			RequestDispatcher rd = request.getRequestDispatcher("teacherpresentinsert.jsp");
		...
		teacherpresentationBean tb = new teacherpresentationBean(cb,TP_Name,TP_Avater,TP_TI_C);
		
		Integer n = ts.insertteacherpresentation(tb);
